...
int main()
{
	...
	unsigned int texture1 = loadTexture("texture_box.png");
	unsigned int texture2 = loadTexture("texture_box_specular3.png");
	unsigned int texture3 = loadTexture("texture_emiss.jpg");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// set up light
		shader.setVec3f("light.position", camera.getPos());
