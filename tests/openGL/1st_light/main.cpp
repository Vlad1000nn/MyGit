...
int main()
{
	...
	glm::vec3 cubeColor = glm::vec3(0.5f, 0.5f, 0.0f);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		unsigned int light_color_loc = glGetUniformLocation(shader.getID(), "lightColor");
		unsigned int object_color_loc = glGetUniformLocation(shader.getID(), "objectColor");

		glUniform3fv(light_color_loc, 1, glm::value_ptr(lightColor));
		glUniform3fv(object_color_loc, 1, glm::value_ptr(cubeColor));
		...
		projLoc = glGetUniformLocation(lightShader.getID(), "proj");
		glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(proj));
